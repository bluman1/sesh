...
export function readAppSettings(): AppSettings {
  ...
  return {
    ...
    gitIndexerEnabled: cfg.get<boolean>("gitIndexerEnabled", false),
    embeddingsEnabled: cfg.get<boolean>("embeddingsEnabled", false),
    embeddingsAutoStart: cfg.get<boolean>("embeddingsAutoStart", false),
    ideaMining: cfg.get<boolean>("ideaMining", false),
